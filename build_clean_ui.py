...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .assistant-body h1 { font-size: 17px; }
  .assistant-body h2 { font-size: 15px; }
    ...
    <div id="input-container">
      <div class="input-inner">
        ...
        <div class="input-pill-wrapper">
          ...
          <button class="attach-btn" title="Attach file" onclick="document.getElementById('hidden-file').click()">
            📎
          </button>
        ...
        <div class="disclaimer">
          Sovereign AI runs 100% on premises. No data leaves your organization.
        </div>
      </div>
    </div>
...
with open(r"d:\Sovereign_AI_Workbench\static\index.html", "w", encoding="utf-8") as f:
    f.write(html)
print("Clean index.html written successfully!")
